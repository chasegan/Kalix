...
fn test_model_with_all_node_types() {
    ...
    let node1_idx: usize;
    {
        ...
        n.inflow_input = DynamicInput::from_string("data.flows_csv.by_index.1", &mut model.data_cache, true, None)
    ...
    let node2_idx: usize;
    {
        ...
        n.evap_mm_input = DynamicInput::from_string("data.rex_mpot_csv.by_name.value", &mut model.data_cache, true, None)
    ...
    let node3_idx: usize;
    {
        ...
        n.demand_input = DynamicInput::from_string("data.constants_csv.by_name.const_20", &mut model.data_cache, true, None)
