...
- Some guys at Victoria University have made some improvements that look good when benchmarked against basic test functions.
  ...
  [Muttil 2008 - Shuffled Complex Evolution Model Calibrating Algorithm.pdf](../../assets/optimisation-algorithms-sce/08_-_Shuffled_Complex_Evolution_Model_Calibrating_Algor_.pdf)
