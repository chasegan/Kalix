...
use crate::misc::misc_functions::{is_valid_variable_name, split_interleaved, true_or_false, parse_csv_to_bool_option_u32, require_non_empty};
    ...
    for (section_name, ini_section) in ini_doc.sections {
        ...
        if section_name == "attributes" {
            ...
            let node_enum= match node_type.as_str() {
                ...
                _ => return Err(format!("Error on line {}: Unknown node type '{}'", ini_section.line_number, node_type))
            };
