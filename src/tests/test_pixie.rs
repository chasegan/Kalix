#[test]
pub fn demonstrate_pixie_io_2() -> Result<(), Box<dyn std::error::Error>> {
    use crate::io::pixie_io::{read_series, read_all_series, get_series_info};

    //let model_filename = "./src/tests/example_data/output_31d6f6b4.pxt";
