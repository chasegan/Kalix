...
MAP = {
    ...
    "tutorials/index.md": ["Modelling Tutorials"],
    ...
    "tutorials/resources/kalix-binary-path.md": ["Specifying the Kalix binary path"],
    "tutorials/resources/notebooks-uv.md": ["Running Python Notebooks"],
}
