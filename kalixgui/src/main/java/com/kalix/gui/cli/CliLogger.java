...
public class CliLogger {
    ...
    private Consumer<String> guiLogCallback;
    
    // Ring buffer for recent log entries (for GUI display)
    ...
    /**
     * Sets a callback for GUI log display.
     */
    public void setGuiLogCallback(Consumer<String> callback) {
        this.guiLogCallback = callback;
    }
    ...
    /**
     * Gets recent log entries for GUI display.
     */
