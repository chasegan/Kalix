...
/**
 * Table property definition for Storage node dimensions.
 * Dimensions is a Level-Volume-Area-Spill table with dynamic rows.
 */
public class StorageDimensionsDefinition implements TablePropertyDefinition {
    ...
    public String getHeaderLine() {
        return "Level [m], Volume [ML], Area [km2], Spill [ML],";
    }
