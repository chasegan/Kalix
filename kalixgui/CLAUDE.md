...
### Compressed Timeseries Format (.kts/.ktm)
Custom binary format using Gorilla compression:
- **Binary format (.kts)**: Gorilla-compressed time series data
- **Metadata format (.ktm)**: Human-readable CSV with series info
...
- `FlowVizDataManager` - CSV/KTM import/export with progress tracking
